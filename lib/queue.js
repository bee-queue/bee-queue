...
class Queue extends Emitter {
  ...
  async removeJob(jobId) {
    await this._evalScript('removeJob', 7,
      this.toKey('jobs'), this.toKey('waiting'), this.toKey('active'),
      this.toKey('succeeded'), this.toKey('failed'),
      this.toKey('delayed'), this.toKey('stalling'), jobId);
