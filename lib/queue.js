  ...
  _waitForJob() {
    ...
    return idPromise.then(
      (jobId) => {
        ...
        // the job before processing can take place, but after the brpoplpush
        // has returned the job id.
        return Job.fromId(this, jobId);
      },
      (err) => {
